                        ...
                        {!canDownload && (
                            <div style={{ textAlign: 'center', padding: '0 0.25rem' }}>
                                <p style={{ fontSize: '0.72rem', color: '#8b949e', margin: '0 0 0.5rem 0', lineHeight: 1.5 }}>
                                    Answer <strong style={{ color: '#e040fb' }}>{MIN_ANSWERS_REQUIRED - answeredCount}</strong> more question{MIN_ANSWERS_REQUIRED - answeredCount !== 1 ? 's' : ''} to reach your daily goal
                                </p>
